    ...
    return(
        <div className="w-full h-1/3 group flex ">
            <div className="w-10 h-[6px] bgOpacity mt-16 relative">
                <span className="absolute w-5 h-5 rounded-full -top-2 -left-3
            ...
            rounded-lg px-10 flex flex-col justify-center gap-5 lgl:gap-10 shadow-shadowOne">
                <div>
                    <h3 className="text-lg md:text-2xl font-semibold group-hover:text-white duration-300">{title}</h3>
                    <p className="text-md md:text-lg mt-2 text-gray-400 group-hover:text-white duration-300">{subtitle}</p>
                </div>
